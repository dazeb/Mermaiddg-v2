...
export const INITIAL_NODES: AppNode[] = [
  {
    ...
    type: 'custom',
    position: { x: 250, y: 50 },
    data: { label: '**Start**\n_Init_ `main()`', type: NodeType.CIRCLE, color: '#10b981' }, // Emerald
  },
  {
    id: 'process',
    type: 'custom',
    position: { x: 250, y: 200 },
    data: { label: 'Process **Data**', type: NodeType.RECTANGLE, color: '#a1a1aa' }, // Zinc-400
  },
  {
    id: 'decision',
    type: 'custom',
    position: { x: 250, y: 350 },
    data: { label: 'Valid?', type: NodeType.RHOMBUS, color: '#f59e0b' }, // Amber
  },
];
